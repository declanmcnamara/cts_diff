...
# Credit: https://github.com/homerjed/sbgm/blob/main/sbgm/models/_unet.py
...
class LinearTimeSelfAttention(eqx.Module):
    ...
    def __init__(self, dim: int, key: Key, heads: int = 4, dim_head: int = 32):
...
class ResnetBlock(eqx.Module):
    ...
    def __call__(
        self, x: Array, t: Union[float, Array], a: Array = None, *, key: Key
    ) -> Array:
        C, _, _ = x.shape
